...
# Computation NASC
nasc2018 <- compute_nasc(path2018, freq)
...
saveRDS(ds_nasc, "/run/media/mmolinet/KER22/données elise/elisou_ta_stagiaire_pref/prepross/NASC/ds_nasc_transect_2018_2021_2023.rds")
