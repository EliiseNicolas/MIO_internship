...
\begin{document}
	...
	l'Analyse par Composante Principale Fonctionnelle (ACPF ou \textit{FPCA} pour Functional Principal Component Analysis)
	...
	\]
	L'objectif de cette étape est de réduire conjointement la dimension des profils de température et de salinité, afin de capturer les modes de variabilité communs aux deux variables (par exemple une thermocline associée à une halocline).
	...
	\paragraph{Gaussian Mixture Model Clustering}
