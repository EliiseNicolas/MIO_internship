...
\end{table}
	...
	\end{figure}
	 ...
	 La figure \ref{fig:mappuritycommunauteskmeansk6pft} représente la distribution spatiale des clusters de contribution des pigments phytoplanctoniques. La communauté 4 est présente au Nord de la région. La communauté 6 est présente principalement aux alentours de Kerguelen. La communauté 2 est présente à la latitude de 35°S, aux alentours du front subtropical. La communauté 3 est présente plus au Sud et à l'Est, à partir de 60°E et 50°S environ. La communauté 1 est présente entre 40 et 45°S. La communauté 5 est présente dans plusieurs régions : en dessous du front subtropical ($\approx$ 35°S) et à partir de 45°S, plutôt à l'Ouest de la région.
	...
	La figure \ref{fig:mappuritycommunauteskmeansk6pft} présente une structuration des communautés selon un gradient latitudinal. Certaines communautés semblent avoir une affinité pour des masses d'eau particulières : la commauté 4 aurait plus d'affinité avec les FOD 6. La communauté 6 est présente principalement aux alentours de Kerguelen (Shelf Zone, non décrite par les FOD, zone riche en fer présentants de forts blooms phytoplanctoniques).  La communauté, présente entre 40 et 45°S, serait majoritairment affiliée au FOD 3). La communauté 3, aurait d'avantage d'affinité pour les eaux du FOD 1. Des tests statistiques sont nécessaire afin de confirmer ces observations. 
