...
\begin{document}
	...
	Les\textbf{ niveaux trophiques intermédiaires} sont tous les étages de la chaine alimentaire, du producteur primaire jusqu'aux prédateur supérieur, le dernier échelon du niveau trophique.
	...
	\subsubsection{Contexte physique de la région}
	...
	D'un point de vue écologique, le réseau trophique de la région contient peu de niveaux. En conséquence : des changements dans les niveaux trophiques primaires affectent rapidement les niveaux trophiques supérieurs. \cite{}. Le producteur primaire du milieu pélagique est le phytoplancton. Les consommateurs primaires sont le zooplancton et le micronecton. Plus particulièrement, la région est marquée par une forte abondance de Krill et d'euphosiacés. \textbf{demander à Marius, peut être mettre directement dans la partie matériel avec l'impact des fréquences.}
	
	\subsection{Contexte de changement climatique}
	Dans un contexte de changement global, les caractéristiques physico-chimiques de l'eau, le vent et d'autres paramètres physiques de notre sont altérés, induisant des changements de structuration des communautés phytoplanctonique (\cite{adroli2026}).
